...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Project::create([
            'title' => 'web profiling EO',
            'description' => 'A web profiling platform for Event Organizers to showcase their event portfolios, services, and booking management dynamically and professionally.',
            'image' => null,
            'url' => 'https://eo-web-profiling.vercel.app/',
            'tech_stack' => 'Web Development, React, Tailwind CSS'
        ]);

        \App\Models\Project::create([
            'title' => 'web ecomerce',
            'description' => 'A premium e-commerce platform designed for florists, featuring custom bouquet building, interactive shopping cart, order management, and secure checkout.',
            'image' => null,
            'url' => 'https://23bouquet.com',
            'tech_stack' => 'Web Development, React, Node.js, MySQL'
        ]);
    }
}
